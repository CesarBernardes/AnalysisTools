...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("HiForestAOD_DATA_FlowAnalysis.root"))
...
process.hltMBOrBSC.HLTPaths = ["HLT_HIMinBiasHfOrBSC_Core*"] # Trigger paths to select - in the case is Minimum Bias
...
#Collect event data
process.demo = cms.EDAnalyzer('AnalyzerFlow') 
