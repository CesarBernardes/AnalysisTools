...
if isHighMultiplicitySample :
   ...
   if multiplicity==3 :
      ...
      ##process.hltHighMultiplicity.HLTPaths = ["HLT_PixelTracks_Multiplicity85_v*"] ##just for syst studies
...
if isHighMultiplicitySample :
   process.p = cms.Path(process.hltHighMultiplicity*process.PAcollisionEventSelection*process.demo)   # Schedule definition
# Schedule definition
