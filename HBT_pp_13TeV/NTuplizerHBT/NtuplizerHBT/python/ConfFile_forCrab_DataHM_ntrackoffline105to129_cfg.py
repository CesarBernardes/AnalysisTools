...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        ...
        ######
        #'/store/user/davidlw/HighMultiplicity/RecoSkim2015_2015DLowPU_ReTracking_v4/151103_083952/0000/pPb_HM_1.root'
...
if isHighMultiplicitySample :
   ...
   if multiplicity==2 :
      ...
      #process.hltHighMultiplicity.HLTPaths = ["HLT_PixelTracks_Multiplicity60_v*"] ##just for syst studies 
   if multiplicity==3 :
